...
PICS_URL = (environ.get('PICS', 'https://walter-white-ca6b.rihanrazak765.workers.dev')).split() #random anime girl img each time from aniwallpaper (Experimental)
PICS = (environ.get('PICS', 'https://graph.org/file/00832d37248ce43e3cb41-41afca5c44b68b4773.jpg')).split()  # Sample pic
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7689365869 6272165202').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003720104763 -1003055581524 -1003183636030').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003607119995'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1003620145507'))  # Bin channel id (make sure bot is admin)
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1003607119995'))  # Premium logs channel id
...
# ============================
QR_CODE = environ.get('QR_CODE', 'https://jolly-sky-b8b7.rihanrazak765.workers.dev')    # QR code image for payments
...
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/+vVfNX48UKpU4ZTFl') # Update channel link for the bot
