...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003720104763 -1003055581524').split()]  # Channel id for auto indexing (make sure bot is admin)
